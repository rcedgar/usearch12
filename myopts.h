...
UNS_OPT(downsample,			0,			0,			UINT_MAX)
...
UNS_OPT(split,				0,			1,			UINT_MAX)	// :document
...
UNS_OPT(mb_per_split,		1,			0,			UINT_MAX)	// :document
...
FLT_OPT(fib,				0.0,		0.0,		1.0)		// Min FIB
